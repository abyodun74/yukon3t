...
const title = "Disclaimer | YuKon3t";
const description =
  "YuKon3t's Disclaimer: the limits on what we can promise about other users, user content, ads, calls, third-party links, availability and liability.";
