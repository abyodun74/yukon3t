    ...
    >
      ...
      <div className="mt-2 flex flex-wrap items-center justify-between gap-2">
            ...
            options={[
              {
                ...
                onSelect: async () => {
                  ...
                  if (native) {
                    if (native.length > 0) await pickImages(native);
                    return;
                  }
        ...
        <div className="flex shrink-0 items-center gap-2">
          ...
          >
            {/* status also goes "uploading" during confirmDeviceCode's
                resubmission above, which isn't wrapped in startTransition
                (isPending would never flip true for it) — checking status
                alone covers both that flow and the normal Post-button
                submit. */}
